...
import org.umtuk.sample.auth.domain.auth.repository.AuthorizationConsentRepository;
...
public class MongoOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
    ...
    public MongoOAuth2AuthorizationConsentService(AuthorizationConsentRepository authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
    ...
    private AuthorizationConsent toEntity(OAuth2AuthorizationConsent authorizationConsent) {
        ...
        entity.getId().setRegisteredClientId(authorizationConsent.getRegisteredClientId());
        entity.getId().setPrincipalName(authorizationConsent.getPrincipalName());
